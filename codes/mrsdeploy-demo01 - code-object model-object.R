# Demo01: R code and model are objects

# In this example, the code comes from an object (code = manualTransmission)
# and the model comes from a model object (model = carsModel).
# For an example of inputs/outputs as dataframes, see "Demo05".
...
swagger <- api$swagger()
cat(swagger, file = "swagger-demo01.json", append = FALSE)
